	...
	var sfdeployurl =
		$('#production').attr('checked') ?
			//'https://githubsfdeploy.herokuapp.com/app/githubdeploy' :
	    		'https://clickdeploy-fluent.herokuapp.com/app/githubdeploy' :
			'https://clickdeploy-fluent.herokuapp.com/app/githubdeploy';
...
function updatebuttonhtml()
{
	...
	var buttonhtml =
		( $('#blogpaste').attr('checked') == 'checked' ? 
			'<a href="https://clickdeploy-fluent.herokuapp.com?owner=' + repoOwner +'&repo=' + repoName + (ref!='' ? '&ref=' + ref : '') + '">\n' :
			'<a href="https://clickdeploy-fluent.herokuapp.com">\n') +					
